...
export default function HomePage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return searchProducts(base, searchValue);
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <Navbar searchValue={searchValue} onSearchChange={(value) => { setSearchValue(value); setPage(1); }} />
      <main className="container py-8">
        <div className="space-y-10">
                  ...
                  <Card key={item.id} className="grid gap-4 rounded-[2rem] border border-slate-200 bg-white p-5 md:grid-cols-[120px_1fr_auto] md:items-center">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                        <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-100 p-2">
                          <Button
                            type="button"
                            className="rounded-full bg-white px-2 py-1 text-slate-700 hover:bg-slate-200"
          ...
          <Footer />
          <CheckoutDialog open={isCheckoutOpen} onOpenChange={setIsCheckoutOpen} items={cart} onCheckout={handleCheckout} />
          {selectedRemoveItem && (
